...
class HeaderCard:
    ...
    def __init__(
        ...
        _guard_vector('HeaderCard.items', items, (Command,), True, False)
    ...
    def dump(self) -> Dict:
        ...
        _guard_vector('HeaderCard.items', self.items, (Command,), True, False)
    ...
    def load(__d: Dict) -> 'HeaderCard':
        ...
        __d_items: Any = __d.get('items')
        _guard_vector('HeaderCard.items', __d_items, (Command,), True, False)
        __d_commands: Any = __d.get('commands')
